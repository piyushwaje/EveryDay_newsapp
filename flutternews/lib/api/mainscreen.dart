...
import 'package:flutternews/api/viewmodel.dart';


import '../newssetails.dart';
import 'categorywiseviewmodel.dart';
import 'newsapi.dart';

class Mainscreen extends StatefulWidget {
  final catviewmodel view;
  final String category;

  Mainscreen({required this.view, required this.category});
...
class _MainscreenState extends State<Mainscreen> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<newsapi>(
        future: widget.view.fetchNewscat(widget.category),
